    ...
    <div className="ServicesLinks">
      {
        (props.track.metadata && props.track.metadata.music[0].external_metadata.spotify) ?
          <a href={`http://open.spotify.com/track/${props.track.metadata.music[0].external_metadata.spotify.track.id}`} target="_blank"><img className="Logo" src={`${process.env.PUBLIC_URL}/Spotify_Icon_RGB_Black.png`} alt="Listen on Spotify"/></a>
      ...
      }
      {
        (props.track.metadata && props.track.metadata.music[0].external_metadata.youtube) ?
          <a href={`https://www.youtube.com/watch?v=${props.track.metadata.music[0].external_metadata.youtube.vid}`} target="_blank"><img className="Logo" src={`${process.env.PUBLIC_URL}/yt_round_monochrome.png`} alt="Listen on YouTube"/></a>
      ...
      }
      {
        (props.track.metadata && props.track.metadata.music[0].external_metadata.deezer) ?
          <a href={`https://deezer.com/track/${props.track.metadata.music[0].external_metadata.deezer.track.id}`} target="_blank"><img className="Logo" src={`${process.env.PUBLIC_URL}/deezer_round_monochrome.png`} alt="Listen on Deezer"/></a>
      ...
      }
      {
        (props.track.metadata && props.track.metadata.music[0].external_metadata.musicbrainz) ?
          <a href={`https://musicbrainz.org/recording/${props.track.metadata.music[0].external_metadata.musicbrainz[0].track.id}`} target="_blank"><img className="Logo" src={`${process.env.PUBLIC_URL}/musicbrainz_monochrome_hexagon.png`} alt="Info on MusicBrainz"/></a>
